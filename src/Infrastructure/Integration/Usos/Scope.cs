...
internal record Scope(string Value)
{
    ...
    public static Scope Cards => new("cards");
    ...
    public static Scope[] All => [CourseTests, Cards, Email, Events, Grades, MobileNumbers, OfflineAccess, OtherEmails, Personal, Photo, PlacementTests, StudentExams, Studies];
